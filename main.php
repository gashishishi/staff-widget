...
add_action( 'widgets_init', function () {
  ...
  register_sidebar( array(  //「サイドバー」を登録する
		'name'          => 'OUR TEAM 1',
		'id'            => 'my_sidebar_1',
		'before_widget' => '<div class=" bg-warning">',
		'after_widget'  => '</div>',
		'before_title'  => '',
		'after_title'   => '',
  ) );
...
class My_Widget extends WP_Widget{
    ...
    if(isset($instance['team_url'])){
        ...
        <p class="d-none d-lg-block text-italic offset-top-0">',$team_rol,'</p>
      </div>
      <figcaption><a class="btn-java btn btn-block btn-rect text-lg-left" href="{$team_url}.html">view full profile</a></figcaption>
     ';
 ...
 ?>
        ...
        <p>
            <label for="<?php echo $team_url_id; ?>">個人ページ</label>
